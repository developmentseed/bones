...
exports['/assets/bones/controllers.js'] = function() {
    assert.response(server, {
        ...
        assert.ok(res.body.indexOf(fs.readFileSync(require.resolve('../test/fixture/node_modules/submodule/controllers/Foo'))) >= 0);
        assert.ok(res.body.indexOf(fs.readFileSync(require.resolve('../test/fixture/controllers/Page'))) >= 0);
